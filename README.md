...
## Story Description
My animated showcase shows 4 games that I play or used to play in the first scene, then in the second scene it shows the charactor I mained in those games.

## Image Filter Analysis
For my Pixalate filter, it is increasing the size or each pixel in the image and for my gray scale filter, it set the color to the average RBG value of each pixel. 
